...
<div class="container py-4">
            ...
            <div class="row align-items-end">
                <div class="col-md-8 d-flex align-items-end">
                    <img src="{{ $business->logo_url ?? 'https://via.placeholder.com/120x120?text=Logo' }}"
                         class="business-logo me-3 me-md-4"
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            {{-- Highlights / Tags --}}
            @php
                $tags = $business->tags ?? ['Family-friendly', 'Locally Owned', 'Outdoor Seating', 'Good for Groups', 'Takes Reservations'];
            @endphp
            <div class="section-card mb-3">
            ...
            @php
                $reviews = $business->reviews ?? [
                    [
                        ...
                        'rating' => 5,
                        'date' => '2 weeks ago',
                        'text' => 'Fantastic experience! Friendly staff, great atmosphere, and the service was top-notch.'
                    ],
                    [
                        'name' => 'James K.',
                        'rating' => 4,
                        'date' => '1 month ago',
                        'text' => 'Really enjoyed my visit here. A few minor delays, but overall very happy and will return.'
                    ],
                ];
            @endphp
        ...
        <div class="col-lg-4">
            ...
            <div class="section-card mb-3">
                ...
                <div class="small mb-2">
                    ...
                    <div>{{ $business->city ?? 'San Diego' }}, {{ $business->state ?? 'CA' }} {{ $business->zip ?? '92101' }}</div>
            ...
            <div id="location" class="section-card mb-3">
                ...
                <div class="map-embed-placeholder mb-2">
                    ...
                    <img src="https://via.placeholder.com/500x260?text=Map+Location"
                         alt="Map location"
