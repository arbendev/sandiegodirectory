                            ...
                            <div class="card h-100 shadow-sm border-0 p-4 hover-lift">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('register', ['type' => 'business']) }}"
                                        class="btn btn-primary w-100 stretched-link">Register Business</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="section-card shadow-sm p-4 p-md-5">
                            <div class="text-center mb-4">
                                ...
                                <p class="text-muted small">Join San Diego Directory to review businesses, save favorites,
                                    and list your own business.</p>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="password" name="password_confirmation"
                                        class="form-control form-control-sm" placeholder="Re-type password">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="section-card">
                            ...
                            <div class="plan-card featured mb-3">
                                ...
                                <div class="plan-price mb-1">$100 <span class="small text-muted">/ month</span></div>
                                <ul class="small mb-2">
